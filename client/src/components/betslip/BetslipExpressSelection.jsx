...
const BetslipExpressSelection = ({ matchData }) => {
    const betslipContext = useContext(BetslipContext);
    const { deleteMatchFromBetslip } = betslipContext;
                ...
                <div>
                    ...
                    <div className="row selection__outcome">
                        <span className="selection__outcome_name">
                            {matchData.chosenOutcome === "1"
                                ? matchData.HomeTeam
                                : matchData.chosenOutcome ||
                                  matchData.chosenOutcome === "2"
                                ? matchData.AwayTeam
                                : matchData.chosenOutcome ||
                                  matchData.chosenOutcome === "X"
                                ? "Draw"
                                : matchData.chosenOutcome}
                        </span>
                        <span>
...
export default BetslipExpressSelection;
